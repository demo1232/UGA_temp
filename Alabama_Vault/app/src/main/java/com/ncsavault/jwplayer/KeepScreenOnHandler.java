package com.ncsavault.jwplayer;
...
public class KeepScreenOnHandler implements VideoPlayerEvents.OnPlayListener,
	...
	/**
	 * Method used for keep on jw player listener.
 	 * @param jwPlayerView Reference of jw player.
	 * @param window Reference of window.
	 */
	...
	/**
	 * Method used to check the wake lock is enable or not
	 * @param enable true and false value.
	 */
