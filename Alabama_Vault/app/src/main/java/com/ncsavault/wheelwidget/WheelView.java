package com.ncsavault.wheelwidget;
...
public class WheelView extends View {
	...
	private final int visibleItems = DEF_VISIBLE_ITEMS;
	...
	public WheelView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, R.style.VaultTheme);
		initData();
	}
	...
	private void initResourcesIfNecessary() {
		if (centerDrawable == null) {
			centerDrawable = ContextCompat.getDrawable(getContext(),R.drawable.wheel_val);
		}
...
//		height = 450;
    ...
    private void layout(int width, int height) {
		...
		LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, 384);
	 ...
	 * Scroll the wheel
	 */
	private void scroll(int itemsToScroll) {
