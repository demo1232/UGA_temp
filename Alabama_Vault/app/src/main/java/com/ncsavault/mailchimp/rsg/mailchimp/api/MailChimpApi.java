package com.ncsavault.mailchimp.rsg.mailchimp.api;
...
public class MailChimpApi {
	...
	protected <T extends RPCStructConverter> List<T> callListMethod(Class<T> clazz, String methodName, Object... params) throws MailChimpApiException, XMLRPCException {
		// call the method
		Object callResult = callMethod(methodName, params);
		if (callResult instanceof Object[]) {
			ArrayList<T> retVal = null;
			try {
				retVal = Utils.extractObjectsFromList(clazz, (Object[]) callResult);
	 ...
	 */
	protected Object callMethod(String methodName, Object... params) throws MailChimpApiException, XMLRPCException {
