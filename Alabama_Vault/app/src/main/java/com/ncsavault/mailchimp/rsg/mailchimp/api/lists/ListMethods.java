package com.ncsavault.mailchimp.rsg.mailchimp.api.lists;
...
import com.ncsavault.mailchimp.rsg.mailchimp.api.campaigns.AbuseReport;
...
public class ListMethods extends MailChimpApi {
	 ...
	 */
	public boolean listSubscribe(String listId, String emailAddress) throws MailChimpApiException, XMLRPCException {
	 ...
	 * @throws MailChimpApiException
	 */
	public boolean listSubscribe(String listId, String emailAddress, MergeFieldListUtil mergeFields, Constants.EmailType emailType) throws MailChimpApiException, XMLRPCException {
	 ...
	 * @throws MailChimpApiException
	 */
	public boolean listUnsubscribe(String listId, String emailAddress) throws MailChimpApiException, XMLRPCException {
	 ...
	 * @throws MailChimpApiException
	 */
	public boolean listUnsubscribe(String listId, String emailAddress, Boolean deleteMember, Boolean sendGoodbye, Boolean sendNotify) throws MailChimpApiException, XMLRPCException {
	 ...
	 * @throws MailChimpApiException
	 */
	public List<String> listsForEmail(String email) throws MailChimpApiException, XMLRPCException {
	...
	public MemberInfo listMemberInfo(String listId, String emailAddress) throws MailChimpApiException, XMLRPCException {
	 ...
	 * @throws MailChimpApiException
	 */
	public List<MemberInfo> listMembers(String listId) throws MailChimpApiException, XMLRPCException {
	 ...
	 * @throws MailChimpApiException
	 */
	public List<MemberInfo> listMembers(String listId, Constants.SubscribeStatus status) throws MailChimpApiException, XMLRPCException {
	 ...
	 * @throws MailChimpApiException
	 */
	public List<MemberInfo> listMembers(String listId, Constants.SubscribeStatus status, Integer start, Integer limit, Date since) throws MailChimpApiException, XMLRPCException {
	 ...
	 * @throws MailChimpApiException
	 */
	public List<AbuseReport> listAbuseReports(String listId) throws MailChimpApiException, XMLRPCException {
	 ...
	 * @throws MailChimpApiException
	 */
	public List<AbuseReport> listAbuseReports(String listId, Integer start, Integer limit, Date since) throws MailChimpApiException, XMLRPCException {
	 ...
	 * @throws MailChimpApiException
	 */
	public BatchResults listBatchSubscribe(String listId, List<MergeFieldListUtil> toSubscribe) throws MailChimpApiException, XMLRPCException {
	...
	public BatchResults listBatchSubscribe(String listId, List<MergeFieldListUtil> toSubscribe, Boolean doubleOptIn, Boolean updateExisting,
										   Boolean replaceInterests) throws MailChimpApiException, XMLRPCException {
	 ...
	 * @throws MailChimpApiException
	 */
	public BatchResults listBatchUnsubscribe(String listId, List<String> toUnsubscribe) throws MailChimpApiException, XMLRPCException {
	...
	public BatchResults listBatchUnsubscribe(String listId, List<String> toUnsubscribe, Boolean deleteMember, Boolean sendGoodbye,
											 Boolean sendNotify) throws MailChimpApiException, XMLRPCException {
	 ...
	 * @throws MailChimpApiException
	 */
	public List<GrowthHistory> listGrowthHistory(String listId) throws MailChimpApiException, XMLRPCException {
	 ...
	 * @throws MailChimpApiException
	 */
	public boolean listInterestGroupAdd(String listId, String groupName) throws MailChimpApiException, XMLRPCException {
	 ...
	 * @throws MailChimpApiException
	 */
	public boolean listInterestGroupDel(String listId, String groupName) throws MailChimpApiException, XMLRPCException {
	 ...
	 * @throws MailChimpApiException
	 */
	public boolean listInterestGroupUpdate(String listId, String oldGroupName, String newGroupName) throws MailChimpApiException, XMLRPCException {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public InterestGroupInfo listInterestGroups(String listId) throws MailChimpApiException, XMLRPCException {
	 ...
	 * @throws MailChimpApiException
	 */
	public boolean listMergeVarAdd(String listId, String tag, String description, MergeFieldOptions options) throws MailChimpApiException, XMLRPCException {
	 ...
	 * @throws MailChimpApiException
	 */
	public List<MergeFieldInfo> listMergeVars(String listId) throws MailChimpApiException, XMLRPCException {
	 ...
	 * @throws MailChimpApiException
	 */
	public boolean listMergeVarDel(String listId, String tag) throws MailChimpApiException, XMLRPCException {
	 ...
	 * @throws MailChimpApiException
	 */
	public boolean listMergeVarUpdate(String listId, String tag, MergeFieldOptions options) throws MailChimpApiException, XMLRPCException {
	 ...
	 * @throws MailChimpApiException
	 */
	public boolean listWebhookAdd(String listId, String url, Integer actionsFlag, Integer sourcesFlag) throws MailChimpApiException, XMLRPCException {
	 ...
	 * @throws MailChimpApiException
	 */
	public boolean listWebhookDel(String listId, String url) throws MailChimpApiException, XMLRPCException {
	 ...
	 * @throws MailChimpApiException
	 */
	public List<WebHookInfo> listWebhooks(String listId) throws MailChimpApiException, XMLRPCException {
	 ...
	 * @throws MailChimpApiException
	 */
	public List<ListDetails> lists() throws MailChimpApiException, XMLRPCException {
