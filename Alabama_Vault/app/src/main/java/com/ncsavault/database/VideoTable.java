...
/**
 * Class used for create a table of video dto and upgrade.
 */
...
public class VideoTable {
    ...
    public static final String KEY_VIDEO_MODIFIED = "videoList_modified";

    public static final String CREATE_VIDEO_TABLE = "CREATE TABLE "
            + VIDEO_TABLE + "(" + KEY_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + KEY_VIDEO_ID + " INTEGER,"
            + KEY_VIDEO_NAME
            + " TEXT," + KEY_VIDEO_SHORT_DESC + " TEXT," + KEY_VIDEO_LONG_DESC
            + " TEXT," + KEY_VIDEO_SHORT_URL + " TEXT," + KEY_VIDEO_LONG_URL + " TEXT,"
            + KEY_VIDEO_THUMB_URL + " TEXT," + KEY_VIDEO_STILL_URL + " TEXT," + KEY_VIDEO_COVER_URL +
            " TEXT," + KEY_VIDEO_WIDE_STILL_URL + " TEXT," + KEY_VIDEO_BADGE_URL + " TEXT," + KEY_VIDEO_DURATION
            ...
            KEY_PLAYLIST_TAGS + " TEXT," + KEY_PLAYLIST_REFERENCE_ID + " TEXT," + KEY_VIDEO_SOCIAL_URL + " TEXT,"
            + KEY_VIDEO_MODIFIED + " INTEGER )";
    ...
    /**
     * Method used for create the video table into data base.
