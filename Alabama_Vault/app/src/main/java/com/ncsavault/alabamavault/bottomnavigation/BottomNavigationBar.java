package com.ncsavault.alabamavault.bottomnavigation;
...
public class BottomNavigationBar implements View.OnClickListener {
    ...
    private LinearLayout mLLBar1, mLLBar2, mLLBar3, mLLBar4, mPanelAddress;
    ...
    public BottomNavigationBar(Context mContext, List<NavigationPage> pages, BottomNavigationMenuClickListener listener) {
        ...
        this.mPanelAddress = (LinearLayout) mActivity.findViewById(R.id.panelAddress);
